...
class Compound(SmartContract):
    ...
    # TODO: make next two functions as one parameterized
...
if __name__ == "__main__":
    ...
    #url = 'https://mainnet.infura.io/v3/039a303ac7f14efcb028d5e27f56a4b4'
    url = 'http://3.130.35.241:8100'
    #url = 'https://mainnet.infura.io/v3/d333d96bcc554339bf2785436471810e'
    ...
    response = compound.retrieve_data_cached()
    ...
    for x in data:
        ...
        for token in x['tokens']:
            ...
            if token['supply_balance_eth'] > max_supply:
        ...
        # TODO: adjust liquidation size instead of removing position
